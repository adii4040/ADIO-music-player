            ...
            <div className=''>
                ...
                <div className='lg:fixed lg:left-[40%] flex flex-col pr-2 md:pt-2'>
                    <div className="flex items-center justify-center gap-2 md:gap-5 ">
                        ...
                        <FaShuffle className={`md:text-xl text-slate-300 ${shuffle ? 'text-red-400  md:w-7 md:h-7 md:p-1 text-sm rounded-xl   ' : ''}`} onClick={() => dispatch(shuffleSong())} />
                        ...
                        <FaRepeat className={`md:text-xl text-slate-300 ${repeat ? ' text-red-400 md:w-7 md:h-7 md:p-1 text-sm rounded-xl  ' : ''}`} onClick={() => dispatch(repeatSong())} />
                    </div>
